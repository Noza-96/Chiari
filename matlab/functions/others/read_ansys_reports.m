function [cas, dat_PC, pcmri, DNS] = read_ansys_reports(subject, cases, mesh_size, ts_cycle, cycle, comparisons)

if nargin == 6 && comparisons == 1
...
for case_name = cases
    for msh = mesh_size
        for ts = ts_cycle
            ...
            output_file = full_path(fullfile(pwd,cas.dirmat,"DNS-results",comparisons, "DNS_" + DNS_case + ".mat"));
            ...
            for n = 1:ts
                ...
                filePath = full_path(correct_path(fullfile(pwd, DNS.path_out_report, '..', comparisons, DNS.case, DNS.case + "_report-" + sprintf('%04d', N)))); 
            ...
            filePath = full_path(correct_path(fullfile(pwd, DNS.path_out_report, '..', comparisons, DNS.case, DNS.case + "_report.out"))); 
