function fig_pressure(subject, case_name, mesh_size, ts, cyc)
    ...
    DNS_case = t_geom + string(t_sim) + b_inlet + "_dx" + formatDecimal(mesh_size) + version  + "_ts_" + ts + "_N_" + cyc;
 ...
 % Annotate max value of dp_diff
    ...
    print(gcf, fullfile(cas.dirfig, "fig_"+fig_ind+"_press"), '-depsc','-vector');
end
